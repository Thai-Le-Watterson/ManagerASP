...
namespace ManagerWeb.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            {
                ListItems.Add(new SelectListItem { Text = department.Name, Value = department.Id.ToString() });
            }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = AppUserManager.UserManager.FindByEmailAsync(Input.Email);
                ...
                if (user.Result == null)
                {
                    ...
                    await _userStore.SetUserNameAsync(newUser, Input.Name, CancellationToken.None);
